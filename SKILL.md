...
1. **诊断摘要** - 一句话概括您的AI落地准备度
2. **数字化程度评估** - 5个维度的详细评分
3. **核心痛点分析** - Top 3痛点及影响分析
4. **AI场景推荐** - 基于您痛点的Top 3推荐场景
5. **首选场景深度分析** - 首选场景的详细方案
6. **落地路线图** - 分3阶段的实施计划
7. **预算参考** - 成本区间参考
8. **风险预警** - 常见坑和合规提醒
9. **下一步行动** - 立即可执行的3个动作
...
> ⚠️ 如果图片无法显示，请点击链接打开：https://www.coze.cn/s/hHL-p7HVdnQ/
> 
> 或搜索微信号：**18514214333** 添加范老师微信

---

**🔧 二维码处理规范**：

诊断师在生成报告时，需确保用户能看到二维码：

1. **优先使用相对路径**：`![二维码](templates/二维码.jpg)`
2. **同时提供备用链接**：图片下方加 `> ⚠️ 如果图片无法显示，请点击链接打开：https://www.coze.cn/s/hHL-p7HVdnQ/`
3. **如果用户反馈图片打不开**：
   - 直接发送公开链接：https://www.coze.cn/s/hHL-p7HVdnQ/
   - 或者用文字说明："您可以搜索微信号：18514214333 添加范老师微信"
...
>
> "建议您预约范老师的一对一沟通，他会给您出一套专属的解决方案。这个诊断报告是免费的，深度服务可以按需选择。"
>
> "您看要不要约个时间聊聊？"
