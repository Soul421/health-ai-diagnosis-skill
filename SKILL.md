...
version: 1.3.0
description: 健康行业AI落地诊断工具。当用户提到以下任一情况时触发：（1）企业想做AI诊断/AI落地诊断/数字化转型诊断；（2）问"我的企业适不适合用AI"、"AI能帮我省多少钱"、"AI怎么落地"；（3）健康/大健康行业企业咨询AI相关问题；（4）企业降本增效、人力优化、自动化改造咨询。诊断流程：收集企业信息→评分计算→ROI分析→场景推荐→工具方案→人才配置→风险评估。输出完整诊断报告。
author: 范铧屿
tags:
  - 健康行业
  - AI落地
